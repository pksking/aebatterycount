...
"AM 200L",
"Item Name/MODEL",
"EXIDE BIKERZ VRLA(48M WARRANTY)",
"E Z4",
"E Z4A",
"E Z5",
"E Z6",
...
"E MLDIN70(ISS)",
"FML0-MLN55(ISS)",
"EXIDE MATRIX(66M WARRNTY)",
"FMTO-MTRED35L/35R",
"FMTO-MTRED45L",
"FMTO-MTREDDIN100",
"EXIDE EEZY(44M WARRANTY)",
"E EY700/L/R",
"FEYO-EY105D31L/R",
"FEPO-EGRID80D26R",
"FEYO-EY34B19L/R",
"EXIDE EXPRESS (36M WARRANTY)",
"XP800",
"XP880",
"FXP5-XP1000",
"XP1200",
...
"RC 18000 PRO (150AH)",
"RC 25000 PRO",
"RC18000 ST (18+18) (150AH)",
"RC18000 TALL (18+18) (150AH)",
"exide",
"6LMS 200L",
"6LMS 150L",
"6LMS100 F",
      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow p-6 space-y-4">
        ...
        <div className="relative mb-4">
          ...
          {showList && results.length > 0 && (
            <div className="absolute w-full bg-white border rounded shadow mt-1 z-10 max-h-56 overflow-y-auto">
              {results.map(r => (
                <div
                  key={r}
                  onClick={() => {
